...
#But du programme : Lancer classify.seqs de Mothur sur un fichier contenant tous les clusters filtres pour tous les echantillons avec banque Silva release 128
